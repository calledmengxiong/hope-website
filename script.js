...
const completeTranslationPatches = {
  zh: {
    ...
    "visit.page1.card1.title": "展会客户交流", "visit.page1.card1.text": "在国际展会上与海外客户面对面交流，沟通材料应用、产品需求和合作机会。", "visit.page1.card2.title": "全球客户会面", "visit.page1.card2.text": "在展会期间接待海外合作伙伴，通过面对面沟通建立更紧密的业务关系。", "visit.page1.card3.title": "国际展会洽谈", "visit.page1.card3.text": "在专业行业展会上与全球客户交流人造革材料及化工材料解决方案。", "visit.page2.card1.title": "工厂参观与技术交流", "visit.page2.card1.text": "海外客户到厂参观，围绕产品性能、质量要求和长期合作进行技术交流。", "visit.page2.card2.title": "工厂参观与技术交流", "visit.page2.card2.text": "海外客户到厂参观生产现场，围绕产品性能、质量控制和实际应用需求进行深入沟通。", "visit.page2.card3.title": "展会合作洽谈", "visit.page2.card3.text": "在展会上会见客户和行业伙伴，介绍材料解决方案并探讨后续合作。",
    "contact.kicker": "联系我们", "contact.title": "我们能为您做什么？", "contact.text": "请发送您的需求，我们会回复产品信息、样品或技术建议。", "contact.emailLabel": "邮箱", "contact.reserve": "+86 182 5924 2218", "contact.address": "中国厦门软件园二期望海路59号", "contact.note": "您也可以通过邮箱或 WhatsApp 直接联系我们。",
  ...
  zhTW: {
    ...
    "gallery.kicker": "眾多客戶信賴", "gallery.title": "全球展會與客戶拜訪", "visit.page1.card1.title": "展會客戶交流", "visit.page1.card1.text": "在國際展會上與海外客戶面對面交流材料應用、產品需求和合作機會。", "visit.page1.card2.title": "全球客戶會面", "visit.page1.card2.text": "展會期間接待海外合作夥伴，建立更緊密的業務關係。", "visit.page1.card3.title": "國際展會洽談", "visit.page1.card3.text": "在專業展會上交流人造革材料及化工材料解決方案。", "visit.page2.card1.title": "工廠參觀與技術交流", "visit.page2.card1.text": "海外客戶到廠參觀並交流產品性能、品質要求和長期合作。", "visit.page2.card2.title": "工廠參觀與技術交流", "visit.page2.card2.text": "海外客戶到廠參觀生產現場，圍繞產品性能、品質控制和實際應用需求進行深入溝通。", "visit.page2.card3.title": "展會合作洽談", "visit.page2.card3.text": "在展會上會見客戶和產業夥伴，介紹材料解決方案。",
    "contact.kicker": "聯絡我們", "contact.title": "我們能為您做什麼？", "contact.text": "請發送您的需求，我們會回覆產品資訊、樣品或技術建議。", "contact.emailLabel": "郵箱", "contact.reserve": "+86 182 5924 2218", "contact.address": "中國廈門軟體園二期望海路59號", "contact.note": "您也可以透過郵箱或 WhatsApp 直接聯絡我們。", "form.name": "姓名", "form.company": "公司", "form.email": "郵箱", "form.phone": "WhatsApp / 電話", "form.product": "感興趣產品", "form.message": "留言", "form.submit": "提交詢盤", "form.note": "您也可以透過郵箱或 WhatsApp 直接聯絡我們。", "form.namePlaceholder": "請輸入您的姓名", "form.companyPlaceholder": "公司名稱", "form.emailPlaceholder": "請輸入您的郵箱", "form.phonePlaceholder": "WhatsApp 或電話", "form.productPlaceholder": "您感興趣的產品", "form.messagePlaceholder": "請填寫您的需求",
